...
- position: MUST be UTG, MP, CO, BTN, SB, or BB. CRITICAL - distinguish these chips: 1) DEALER BUTTON = white/cream circle with "D" letter inside, sits NEXT TO a player's avatar. 2) BLIND CHIPS = small colored circles with "1c" or "5c" showing cent amounts, sit IN FRONT of players with their bet. IGNORE blind chips! ONLY use the "D" button. Once you find the D: that player is BTN. Go LEFT from BTN: SB, BB, UTG, MP, CO. Hero is at BOTTOM of screen.
