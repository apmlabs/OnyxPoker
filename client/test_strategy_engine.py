...
def test_preflop():
    ...
    # Test both value_lord and value_maniac (same preflop ranges)
    for strategy in ['value_lord', 'value_maniac']:
        engine = StrategyEngine(strategy)
        print(f"\n=== Testing {strategy.upper()} preflop ===")
        ...
        tests = [
            ...
            (['Ah', '5h'], 0.07, 0, False, 'UTG', 'raise', f'A5s opens UTG ({strategy} is wide)'),
            ...
            (['Th', 'Th'], 0.17, 0.10, True, 'BTN', 'raise', f'TT 3-bets ({strategy})'),
            (['9h', '8h'], 0.17, 0.10, True, 'BTN', 'call', '98s calls open IP'),
            (['Qh', 'Jc'], 0.17, 0.10, True, 'BTN', 'call', 'QJo calls open IP'),
            (['Ah', 'Qc'], 0.17, 0.10, True, 'BTN', 'raise', f'AQo 3-bets ({strategy})'),
            ...
            (['Ah', 'Kh'], 0.50, 0.35, True, 'BTN', 'raise', f'AKs 4-bets ({strategy})'),
            (['Qh', 'Qh'], 0.50, 0.35, True, 'BTN', 'raise', f'QQ 4-bets ({strategy})'),
            (['Th', 'Th'], 0.50, 0.35, True, 'BTN', 'call', 'TT calls 3bet'),
            (['9h', '9h'], 0.50, 0.35, True, 'BTN', 'call', f'99 calls 3bet ({strategy})'),
            ...
            (['Ah', '2h'], 0.07, 0, False, 'UTG', 'raise', f'A2s opens UTG ({strategy} wide)'),
        ]
...
def test_postflop():
    ...
    # Test both value_lord and value_maniac
    for strategy in ['value_lord', 'value_maniac']:
        engine = StrategyEngine(strategy)
        print(f"\n=== Testing {strategy.upper()} postflop ===")
        ...
        tests = [
            ...
            # === WEAK HANDS ===
            (['Ah', 'Kh'], ['Qc', '7d', '2c'], 0.5, 0.25, 'BTN', 'call', f'AK overcards calls ({strategy})'),
...
def test_vision_edge_cases():
    ...
    engine = StrategyEngine('value_maniac')
