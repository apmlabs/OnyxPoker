...
def test_preflop():
    ...
    tests = [
        ...
        (['Ah', '5h'], 0.07, 0, False, 'UTG', 'raise', 'A5s opens UTG (value_maniac is wide)'),
        ...
        (['Th', 'Th'], 0.17, 0.10, True, 'BTN', 'raise', 'TT 3-bets (value_maniac)'),
        (['9h', '8h'], 0.17, 0.10, True, 'BTN', 'call', '98s calls open IP'),
        (['Qh', 'Jc'], 0.17, 0.10, True, 'BTN', 'call', 'QJo calls open IP'),
        (['Ah', 'Qc'], 0.17, 0.10, True, 'BTN', 'raise', 'AQo 3-bets (value_maniac)'),
        ...
        (['Ah', 'Kh'], 0.50, 0.35, True, 'BTN', 'raise', 'AKs 4-bets (value_maniac)'),
        (['Qh', 'Qh'], 0.50, 0.35, True, 'BTN', 'raise', 'QQ 4-bets (value_maniac)'),
        (['Th', 'Th'], 0.50, 0.35, True, 'BTN', 'call', 'TT calls 3bet'),
        (['9h', '9h'], 0.50, 0.35, True, 'BTN', 'call', '99 calls 3bet (value_maniac)'),
        ...
        (['Ah', '2h'], 0.07, 0, False, 'UTG', 'raise', 'A2s opens UTG (value_maniac wide)'),
    ]
